---
title: "UC Flare-Up: What It Is, Triggers, and What to Do"
description: "A UC flare is when symptoms return or worsen. Learn common flare triggers, warning signs, and what questions to bring to your GI doctor."
...
Flares can be mild, moderate, or severe, and their duration varies widely — some resolve within a few weeks with treatment, others last months.
...
Missing doses of UC medication — even briefly — is one of the most common reasons people flare. Mesalamine and other maintenance medications are intended to be taken consistently, not just during active symptoms.
...
No specific diet causes UC, but certain foods may aggravate symptoms during a flare. High-fiber raw vegetables, dairy (for people with lactose sensitivity), spicy foods, alcohol, and caffeine are common triggers for some patients during active disease.
...
Your doctor will guide this decision based on your individual history and how you respond to initial treatment.
...
- Eat easy-to-digest foods (see our guide on what to eat during a flare)
- Rest when possible
