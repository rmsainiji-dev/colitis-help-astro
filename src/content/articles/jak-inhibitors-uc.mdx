...
Unlike biologics — which are large proteins that block targets outside cells — JAK inhibitors are small enough to enter cells and block signaling from the inside. This is why they can be taken as a pill. For a full comparison with biologics, see our guide on [biologics for ulcerative colitis](/blog/biologics-for-ulcerative-colitis).
...
Some patients and doctors prefer JAK inhibitors because of the convenience of oral dosing; others prefer biologics based on efficacy data, insurance coverage, or risk profile. See the full [ulcerative colitis treatment options overview](/blog/ulcerative-colitis-treatment-options) for context on where both fit in the treatment landscape.
...
If [mesalamine is not working](/blog/mesalamine-not-working-ulcerative-colitis) and your disease is moderate to severe, your gastroenterologist may discuss JAK inhibitors as a step-up option. Your gastroenterologist will assess your overall health, disease activity, and medical history before recommending one.
