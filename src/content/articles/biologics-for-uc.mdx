...
In UC, the immune system mistakenly attacks the lining of the colon. Biologics interrupt this process by blocking specific proteins or receptors involved in the inflammatory response. They are typically considered when [aminosalicylates like mesalamine are not working](/blog/mesalamine-not-working-ulcerative-colitis) well enough to control symptoms.
...
Your gastroenterologist will assess your disease activity (typically via symptoms, blood tests, and sometimes endoscopy) before recommending a biologic. For a full comparison of how biologics fit into the treatment landscape, see our overview of [ulcerative colitis treatment options](/blog/ulcerative-colitis-treatment-options).
...
If one biologic does not work, switching to a different biologic — or to a different medication class such as [JAK inhibitors](/blog/jak-inhibitors-ulcerative-colitis) — is a common next step.
